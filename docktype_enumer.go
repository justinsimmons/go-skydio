// Code generated by "enumer -type=DockType -transform=snake-upper -trimprefix=DockType -json"; DO NOT EDIT.
...
// MarshalJSON implements the json.Marshaler interface for DockType
func (i DockType) MarshalJSON() ([]byte, error) {
	return json.Marshal(i.String())
}

// UnmarshalJSON implements the json.Unmarshaler interface for DockType
func (i *DockType) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("DockType should be a string, got %s", data)
	}

	var err error
	*i, err = DockTypeString(s)
	return err
}
