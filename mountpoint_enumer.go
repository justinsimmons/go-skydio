// Code generated by "enumer -type=MountPoint -transform=snake-upper -trimprefix=MountPoint -json"; DO NOT EDIT.
...
// MarshalJSON implements the json.Marshaler interface for MountPoint
func (i MountPoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(i.String())
}

// UnmarshalJSON implements the json.Unmarshaler interface for MountPoint
func (i *MountPoint) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("MountPoint should be a string, got %s", data)
	}

	var err error
	*i, err = MountPointString(s)
	return err
}
