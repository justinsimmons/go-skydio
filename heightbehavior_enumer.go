// Code generated by "enumer -type=HeightBehavior -transform=snake-upper -trimprefix=HeightBehavior -json"; DO NOT EDIT.
...
// MarshalJSON implements the json.Marshaler interface for HeightBehavior
func (i HeightBehavior) MarshalJSON() ([]byte, error) {
	return json.Marshal(i.String())
}

// UnmarshalJSON implements the json.Unmarshaler interface for HeightBehavior
func (i *HeightBehavior) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return fmt.Errorf("HeightBehavior should be a string, got %s", data)
	}

	var err error
	*i, err = HeightBehaviorString(s)
	return err
}
